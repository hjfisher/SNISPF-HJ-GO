...
injection as Linux (the seq_id trick) using the **WinDivert** driver. The same
backend also powers **MITM upstream raw injection** when
`MITM_RAW_INJECTION=true` (see the MITM section).
